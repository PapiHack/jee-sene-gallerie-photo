	...
	<div class="container">
		...
		<c:if test="${ welcome != null }">
			...
			<div class="col-lg-12 jumbotron">
				<h1>Bienvenue sur <i>#SèneGalleriePhoto</i>, votre réseau social de partage de photos.</h1>
				<p>
					Sène Gallerie Photo est une plateforme ou réseau social, permettant une certaine
					interaction entre ses utilisateurs via le partage d'albums photo.
				</p>
				<p>
